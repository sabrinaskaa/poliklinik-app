            ...
            <form action="{{ route('dokter.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}"
                            ...
                            class="input input-bordered border-2 rounded-lg p-2 w-full 
                                      ...
                                      @error('nama') input-error @enderror"
                            required>
                        @error('nama')
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="no_ktp" value="{{ old('no_ktp') }}"
                            ...
                            class="input input-bordered border-2 rounded-lg p-2 w-full
                                      focus:ring-2 focus:ring-primary
                                      @error('no_ktp') input-error @enderror"
                            required>
                        @error('no_ktp')
                            <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="no_hp" value="{{ old('no_hp') }}"
                            ...
                            class="input input-bordered border-2 rounded-lg p-2 w-full
                                      focus:ring-2 focus:ring-primary
                                      @error('no_hp') input-error @enderror"
                            required>
                        @error('no_hp')
                            <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                        @enderror
                ...
                <div class="form-control mb-6">
                    ...
                    <textarea name="alamat" rows="3" placeholder="Masukkan alamat..."
                        class="textarea textarea-bordered border-2 rounded-lg p-2 w-full
                                     focus:ring-2 focus:ring-primary
                                     @error('alamat') textarea-error @enderror"
                ...
                <div class="form-control mb-6">
                    ...
                    <select name="id_poli"
                        class="select select-bordered border-2 rounded-lg p-2 w-full
                                   focus:ring-2 focus:ring-primary
                                   @error('id_poli') select-error @enderror"
                        required>
